...
public class Unit : MonoBehaviour {
	...
	private int bluntDamage; //this is the amount of damage the player does atm, if needs buff, change weaponDamage in Start method
	private int slashDamage; //at the moment, damage is flat for debugging purposes, once game works and stuff, damage will be something like (damage + random(.1f * damage, .4f * damage))
	...
	void Update () {
		...
		currentTileCoord.x = tileX+0.5f;
		currentTileCoord.z = tileZ+0.5f;
